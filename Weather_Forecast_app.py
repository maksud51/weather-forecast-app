...
# model_path = 'C:/Users/21. Technology/Downloads/Task/weather_forecast_model(lstm).h5'  # Replace with the actual path
model_path = 'model/weather_forecast_model(lstm).h5'
saved_model = load_model(model_path)

# Load data and prepare encoders (replace with your actual data path)
# data = pd.read_csv('C:/Users/21. Technology/Downloads/Task/preprocessed_weather_data.csv')
